export enum EGenero
    ...
    export enum ETipoAditivo { Prazo, Valor, Quantidade, Qualidade }
    ...
    export enum ESituacaoContrato { EmValidacao, EmAssinatura, EmRevisao, Vigente, Concluido, Rescindido }

    export enum EModeloGestaoContrato { FaturamentoSobDemanda, FaturamentoConclusaoAtendimento, FaturamentoAntecipado, FaturamentoConclusaoContrato }
    //---------------------
